...
//        if (DemoCache.getAccount().equals(account)) {
    ...
    private void switchRender(String user1, String user2)
    {
        ...
        if (LoaderApp.getCurAccount().getAccount().equals(user1))
        {
        ...
        if (LoaderApp.getCurAccount().getAccount().equals(user2))
        {
            AVChatManager.getInstance().setupLocalVideoRender(null, false, 0);
        }
        else
        ...
        if (user1 == LoaderApp.getCurAccount().getAccount())
        {
        ...
        if (user2 == LoaderApp.getCurAccount().getAccount())
        {
