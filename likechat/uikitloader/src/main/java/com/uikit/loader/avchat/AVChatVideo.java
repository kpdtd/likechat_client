...
public class AVChatVideo implements View.OnClickListener, ToggleListener
{
    ...
    private void showProfile()
    {
        ...
        String account = LoaderApp.getCurAccount().getAccount();
...
//        }
    ...
    {
        int viewId = v.getId();
        if (viewId == R.id.avchat_video_logout)
        {
            listener.onHangUp();
        }
        ...
        else if (viewId == R.id.avchat_video_mute)
        {
            listener.toggleMute();
        }
        else if (viewId == R.id.avchat_video_switch_audio)
        {
            if (isInSwitch)
            {
        ...
        else if (viewId == R.id.avchat_switch_camera)
        {
            listener.switchCamera();
        }
        else if (viewId == R.id.avchat_close_camera)
        {
            listener.closeCamera();
        }
        else if (viewId == R.id.avchat_video_record)
        {
